...
async def start_command(message:Message):
    ...
    try:
        ...
        await message.answer(text="Assalomu alaykum, botimizga xush kelibsiz!\nBotimiz orqali siz valyutalar narxini /valc kommandasi orqali bilib olishingiz mumkin")
    except:
        await message.answer(text="Assalomu alaykum! Biror valyuta kursini tanlang!")
